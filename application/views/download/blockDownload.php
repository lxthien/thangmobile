            ...
            <div class="3">
                <?php foreach ( $tinCongNghe as $_watch ): ?>
                    <div class="sreencontentdownload">
                        <div class="imges-block-you-see"><a href="<?php echo base_url('tin-tuc/thong-tin-cong-nghe/'.$_watch['id_news'].'-'.$_watch['link_rewrite'].'.html'); ?>">
        ...
        <div class="boxdownload">
            <div class="3">
                <?php foreach ( $newsThangMobile as $_watch ): ?>
                    <div class="sreencontentdownload">
                        <div class="imges-block-you-see"><a href="<?php echo base_url('tin-tuc/tin-tuc-noi-bo-thang-mobile-ba-ria-vung-tau/'.$_watch->id_news.'-'.$_watch->link_rewrite.'.html'); ?>">
                            <img src="<?php echo image($_watch->news_icon, 'news_90_80'); ?>" alt="<?php echo $_watch->title; ?>"/></a>
                        </div>
                        <a class="link-block-you-see" href="<?php echo base_url('tin-tuc/tin-tuc-noi-bo-thang-mobile-ba-ria-vung-tau/'.$_watch->id_news.'-'.$_watch->link_rewrite.'.html'); ?>" title="<?php echo $_watch->title; ?>">
                            <p><?php echo $_watch->title; ?></p>
                        </a>
                        <p><?php echo date_format(new DateTime($_watch->date_add), 'd/m/Y'); ?></p>
                    </div>
