...
<body class="dashboard">
    <div class="dashboard-header">
        <div class="dashboard">
            <a href="<?php echo base_url(); ?>" target="_blank">
                <img src="<?php echo base_url().'assets/admin'; ?>/assets/img/logo.png" alt="Yes Mobile Logo, điện thoại vũng tàu">
            </a>
    ...
    <div class="dashboard-body">
        <div class="dashboard">
            <div class="text-center">
                <h1>PHẦN MỀM QUẢN LÍ CÔNG VIỆC NỘI BỘ</h1>
            ...
            <div class="tab-content">
                <div class="row">
                    <div class="col-md-6 col-link-left">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p><span>- Pin iPhone, ép kính bảo hành 12 tháng.</span></p>
								<p><span>- Pin Android, iPad bảo hành 6 tháng.</span></p>
                                <p><span>- Màn hình iPhone, LCD iPad, cảm ứng iPad bảo hành 6 tháng. </span></p>
								<p><span>- LCD, cảm ứng Android, ép cảm ứng bảo hành 3 tháng.</span></p>
                                <p><span>- Sửa chữa (không liên quan đến ic), bảo hành 6 tháng.</span></p>
                                <p><span>- Sửa chữa liên quan đến ic bảo hành 2-3 tháng.</span></p>
                    ...
                    <div class="col-md-6">
                        ...
                        <p><span><b>- Nhận máy:</b></span> lấy mật khẩu, nhất là máy mất nguồn, không lên màn hình.</p>
                        <p><span><b>- BP.KT:</b></span> Trả lại linh kiện cũ cho khách, sạc pin sau khi sửa xong.</p>
						<br>
					    <p><b>LINH KIỆN</b></p>
                        ...
                        <br>
                        <p><b>MÁY XÁC LẤY LINH KIỆN</b></p>
                        <p><span>- iPhone 8 đỏ - 01/06</span></p>
						<p><span>- iPhone 7 đen - 27/05</span></p>
                        <p><span>- MTB Samsung T561Y</span></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="dashboard-footer">
        <div class="dashboard">
            ...
            <p><span>Điện thoại: (0254) 6 557 999 - Hotline: 0847 72 72 72</span></p>
