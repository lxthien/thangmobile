<div class="sreenbaner" style="width:980px; height: 290px; float:left; margin-top:10px;">
    ...
    <div class="banner">
        <div class="banner-6of12"><a href="http://dienthoaivungtau.com/san-pham/dien-thoai"><img src="<?php echo image('assets/images/Ban-hang-tra-gop5047.jpg', 'banner_168_87'); ?>"></a></div>
        <div class="banner-6of12"><a href="http://dienthoaivungtau.com/san-pham/dien-thoai/may-tinh-bang"><img src="<?php echo image('assets/images/Samsung-Galaxy-Tab-4-389-x146.jpg', 'banner_168_87'); ?>"></a></div>
        <div class="banner-6of12"><a href="http://dienthoaivungtau.com/tuyen-dung.html"><img src="<?php echo image('assets/images/Tuyen-Dung-T9.jpg', 'banner_168_87'); ?>"></a></div>
        <div class="banner-6of12"><a href="#"><img src="<?php echo image('assets/images/Ban-hang-tra-gop_02.jpg', 'banner_168_87'); ?>"></a></div>
